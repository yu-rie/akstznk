...
// ひらがなを数値に変える用の表
const strArr = [
  'ぁあかがさざただなはばぱまゃやらわんァアカガサザタダナハバパマャヤラワン',
  'ぃいきぎしじちぢにひびぴみゐりィイキギシジチヂニヒビピミヰリ',
  'ぅうくぐすずっつづぬふぶぷむゅゆるゥウクグスズッツヅヌフブプムュユル',
  'ぇえけげせぜてでねへべぺめゑれェエケゲセゼテデネヘベペメヱレ',
  'ぉおこごそぞとどのほぼぽもょよろをォオコゴソゾトドノホボポモョヨロヲ'
]
